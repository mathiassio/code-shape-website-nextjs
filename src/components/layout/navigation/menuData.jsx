...
export const footer = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/codeshapeio",
      icon: (props) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/codeshapeio/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/CodeshapeIO",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: "GitHub",
      href: "https://github.com/Code-Shape",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/codeshapeio",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
