...
export default function Pages({ page, renderH2Links }) {
  return (
    <Wrapper>
      <Head>
      ...
      <Content className="mt-6 prose md:prose-xl dark:prose-dark dark:md:prose-xl-dark mx-auto">
        {documentToReactComponents(
          page.content.json,
          getRichTextRenderOptions(page.content.links, (renderH2Links = "true"))
        )}
      </Content>
    </Wrapper>
  );
