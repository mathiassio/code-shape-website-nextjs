...
export async function getStaticProps() {
  ...
  return {
    props: {
      authors: authors.authorCollection.items,
    },
  };
}
          ...
          <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
            <div className="space-y-5 sm:space-y-4">
              ...
              <p className="text-xl text-gray-500">
                We are driven by technology, and the way it can enrich peoples
                lives. We believe in a better future through learning, which
                ultimately leads to incredible experiences.
              </p>
            </div>
                      ...
                      <div className="sm:col-span-2">
                        <div className="space-y-4">
                          <div className="text-lg leading-6 font-medium space-y-1">
                            <h3>{author.name}</h3>
                            <p className="text-indigo-600">{author.title}</p>
                          </div>
                          <div className="text-lg">
                            <p className="text-gray-500">{author.biography}</p>
                          </div>
